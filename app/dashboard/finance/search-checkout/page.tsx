            ...
            <div className="max-w-5xl mx-auto">
                ...
                {transactionDetails && (
                    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                        ...
                        <div className="mt-6">
                            {activeTab === "details" && <DetailSection details={transactionDetails} />}
                            {activeTab === "customer" && (
                                <JSONViewer label="Customer Details" data={transactionDetails.customer} />
                            )}
                            {activeTab === "business" && (
                                <BusinessSection
...
function TabHeader({
    ...
    const tabs = ["details", "customer", "business"];
    return (
...
function DetailSection({ details }: { details: any }) {
    const items = [
        ["ID", details.id],
        ["Business ID", details.business_id],
        ["Customer ID", details.customer_id],
        ["Currency", details.currency],
        ["Amount", details.amount],
        ["Fee", details.fee],
        ["Total", details.total],
        ["Fee Bearer", details.feeBearer],
        ["Paid Amount", details.paidAmount ?? "N/A"],
        ["Paid Difference", details.paidDifference ?? "N/A"],
        ["Paid Note", details.paidNote ?? "N/A"],
        ["Name", details.name],
        ["Email", details.email],
        ["Phone", details.phone || "N/A"],
        ["Transaction Ref", details.transactionRef],
        ["Reference", details.reference],
        ["Initiation Tran Ref", details.initiationTranRef],
        ...
        ["Account Expiry", details.accountExpiry],
        ["Domain", details.domain],
        ["IP", details.ip],
        ["Trans ID", details.trans_id ?? "N/A"],
        ["Crypto Wallet ID", details.crypto_wallet_id ?? "N/A"],
        ["Redirect URL", details.redirectUrl || "N/A"],
        ["Title", details.title],
        ["Description", details.description || "N/A"],
        ["Logo URL", details.logoUrl || "N/A"],
        ["Status Description", details.status_desc ?? "N/A"],
        ["Status", details.status],
        ["Extra", details.extra ?? "N/A"],
        ["Created At", details.created_at],
        ["Updated At", details.updated_at],
        ["Tokenize", details.tokenize ? "Yes" : "No"],
        ["System Fee", details.sys_fee ?? "N/A"],
...
function BusinessSection({
    ...
    return (
        <div className="space-y-2">
            ...
            <p><strong>Phone:</strong> {business?.biz_phone ?? "N/A"}</p>
            <p><strong>Website:</strong> {business?.biz_url ?? "N/A"}</p>
            <p><strong>Address:</strong> {business?.biz_address ?? "N/A"}</p>
            <button
                onClick={() =>
                    router.push(
