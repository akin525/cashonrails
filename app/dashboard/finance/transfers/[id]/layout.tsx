                ...
                <div className='flex items-start mt-10 gap-20 justify-between max-w-4xl'>
                    <div className='grid gap-5 grid-cols-2 max-w-96'>
                        ...
                        <ul className='text-sm space-y-2'>
                            <li><Chip variant={transaction?.status}>
                                {StringUtils.capitalizeWords(transaction?.status ?? "")}
                            </Chip></li>
                            <li> {moment(transaction?.created_at).format('MMM DD, YYYY, h:mm a')} </li>
                            <li>{transaction?.narration} </li>
                        </ul>
                    </div>
                    <div>
                        <p className='text-[#00000099] font-medium'>Amount</p>
                        <p className='text-[#01AB79] text-2xl font-semibold'>N{transaction?.amount}</p>
                    </div>
                </div>
                {children}
            </div>
