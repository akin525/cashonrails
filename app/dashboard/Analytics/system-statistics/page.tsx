            ...
            <div className="max-w-7xl mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 space-y-6">
                ...
                >
                    <input
                        ...
                        className="p-3 border rounded-md w-full md:w-1/2 focus:ring-2 focus:ring-green-400 dark:bg-gray-800 dark:text-white dark:border-gray-700"
                        required
                    />
                ...
                {stats && (
                    <div className="space-y-10">
                        <h3 className="text-lg text-center font-semibold text-gray-700 dark:text-gray-300">
                            Showing stats for <span className="text-green-600 dark:text-green-400">{selectedDate}</span>
                        </h3>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div
                                ...
                                <h4 className="font-semibold text-center mb-4 text-gray-800 dark:text-gray-200">Total
                                    Revenue</h4>
                            ...
                            <div
                                ...
                                <h4 className="font-semibold text-center mb-4 text-gray-800 dark:text-gray-200">Revenue
                                    Breakdown</h4>
                  ...
                  />
                                            <span>
                    {entry.name} - {getCurrencySymbol(currency)}{Number(entry.value).toLocaleString()}
                  </span>
                                        </div>
                                    ))}
                                </div>
