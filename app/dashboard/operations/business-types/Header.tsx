...
const BusinessTypeHeader: React.FC = () => {
    ...
    <>
      <header className="flex items-center justify-between p-4 border-b border-bar min-h-auto relative flex-wrap gap-2">
        ...
        <nav className="flex items-center space-x-3">
          {/* <DateRangeSelector relativeRange={''} 
            onRelativeRangeChange={handleDateFilterChange} 
          ...
          <button onClick={() => {}} className="bg-[#01AB79] border-[#01AB79] border flex items-center font-medium text-sm py-2 px-4 rounded-md text-white">
            <PlusIcon stroke='white' /> New Business Type
          </button>
        </nav>
